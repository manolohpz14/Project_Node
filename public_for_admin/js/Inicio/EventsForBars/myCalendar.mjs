...
function eventForCalendar (obj_actividades, create_activities_admin) {
    ...
    formContainer.innerHTML = `
        ...
        <label>Tema: <input type="text" id="tema" required></label><br><br>
        <label>Color: <input type="color" id="color" value="#000000"></label><br><br>
        <label>Actividad: <input type="text" id="actividad" required></label><br><br>
        <label>Fecha fin: <input type="date" id="fecha_fin" required></label><br><br>
        <label>Abreviación: <input type="text" id="abreviacion" required></label><br><br>
        <label>Explicación: <textarea id="explicacion"></textarea></label><br><br>
        <button id="submitActivity" style="background-color:#2196F3;color:white;padding:0.5rem 1rem;border:none;border-radius:5px;cursor:pointer;">Crear</button>
    `;
