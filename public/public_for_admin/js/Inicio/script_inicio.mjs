...
import {getCookie, get_all_photo,last_conexion,get_all_messages,upload_message,set_full_time_at_page,
  get_full_time_at_page,get_all_activities,upload_activity,get_all_activities_user,deleteActivityAndFile,
  downloadFile, create_activities_admin} from "./Fetchs/fetchs.mjs"
...
try {
  ...
  function my_listeners_sidebar(){
    ...
    eventForCalendar(obj_actividades, create_activities_admin)
