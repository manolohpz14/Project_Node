    ...
    setTimeout(() => {
      ...
      function pintar(objeto, objeto_foto) {
        for (let i = 0; i < objeto.length; i++) {
          ...
          const safeUsername = persona.username.replace(/\W/g, "");
          const safeFecha = persona.fecha_anuncio.replace(/\W/g, "");
          div.id = `comment-${safeUsername}-${safeFecha}`;
          ...
          btnResponder.style.marginTop = "1rem";
          ...
          btnResponder.addEventListener("click", () => {
            alert(`Responder a ${persona.username}`);
          });
          ...
          likeIcon.style.fontSize = "1.5rem";
